...
def evaluate_with(
    ...
    for item in with_node.items:
        context_manager = evaluate_ast(item.context_expr, state, static_tools, custom_tools, authorized_imports)
        enter_result = context_manager.__enter__()
        contexts.append(context_manager)
