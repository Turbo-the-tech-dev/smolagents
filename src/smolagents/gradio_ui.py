...
class GradioUI:
    ...
    def upload_file(self, file, file_uploads_log, allowed_file_types=None):
        ...
        if file_ext not in allowed_file_types:
            gr.Warning(f"File type {file_ext} not allowed.")
            return file_uploads_log
        ...
        gr.Info(f"File uploaded: {sanitized_name}")
            ...
            with gr.Sidebar():
                ...
                with gr.Group():
                    ...
                    text_input = gr.Textbox(
                        ...
                        autofocus=True,
                        html_attributes={"aria-label": "Chat input"},
                    )
                ...
                gr.HTML(
                    "<div style='text-align: center;'><br><br><h4>Powered by <a target='_blank' href='https://github.com/huggingface/smolagents'><b>smolagents</b></a></h4></div>"
                )
