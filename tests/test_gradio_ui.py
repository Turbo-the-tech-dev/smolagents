        ...
        for file_type in disallowed_types:
            with tempfile.NamedTemporaryFile(suffix=file_type) as temp_file:
                ...
                with patch("gradio.Warning") as mock_warning:
                    ...
                    mock_warning.assert_called_once_with(f"File type {file_type} disallowed")
    ...
    def test_upload_file_invalid_type(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".exe") as temp_file:
            ...
            with patch("gradio.Warning") as mock_warning:
                ...
                mock_warning.assert_called_once_with("File type .exe disallowed")
                self.assertEqual(len(uploads_log), 0)
    ...
    def test_upload_file_special_chars(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".txt") as temp_file:
            ...
            try:
                ...
                with patch("shutil.copy"), patch("gradio.Info") as mock_info:
                    uploads_log = self.ui.upload_file(mock_file, [])
